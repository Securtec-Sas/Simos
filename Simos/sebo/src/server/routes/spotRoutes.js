...
// const {addAnalyzeSymbolsAsync} = require('../controllers/analizerController');
const {addSymbolsForExchange}= require('../controllers/symbolController');
const {analisisExchangeSimbol} = require('../controllers/analizerController'); // Comentada para usar el objeto completo


// ...otras rutas...

router.get('/symbol', addSymbolsForExchange);
 ...
 */
// router.get('/depure', depuredExchangeSymbolData);
 ...
 */
router.get('/promedios', analisisExchangeSimbol); // Usando acceso directo a la propiedad
