...
class TradingLogic:
    ...
    def __init__(self, exchange_manager: ExchangeManager, data_persistence: DataPersistence, ai_model: ArbitrageAIModel = None):
        ...
        # Asegurar que el modelo AI use red neuronal por defecto
        self.ai_model = ai_model or ArbitrageAIModel(use_neural_network=True)
        self.logger.info(f"Modelo AI inicializado - Tipo: {'Red Neuronal TensorFlow' if self.ai_model.use_neural_network else 'Modelos sklearn'}")
